    ...
    for pat in _patterns(language):
        ...
        for match in re.finditer(re.escape(pat.comparable), comp_sentence):
            ...
            lesson_data = {
                ...
                "source_location": pat.entry.get("source_location"),
                "source_quote": pat.entry.get("source_quote"),
                "source_note": pat.entry.get("source_note"),
                "source_url": pat.entry.get("source_url"),
