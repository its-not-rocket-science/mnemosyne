...
_B1: frozenset[str] = _CEFR_B1.get("he", frozenset())
_B2: frozenset[str] = _CEFR_B2.get("he", frozenset())
_C1: frozenset[str] = _CEFR_C1.get("he", frozenset())
_C2: frozenset[str] = _CEFR_C2.get("he", frozenset())
