...
| Alembic migrations | implemented | `0000_baseline` + migrations 0001–0008; `alembic upgrade head` verified on fresh SQLite DB; production startup uses subprocess alembic only |
