...
_SUBCATEGORY_VALUES: dict[str, list[str]] = {
    "zh": ["chengyu", "xiehouyu", "suyv", "yanyu", "idiom", "peking_opera",
           "classical_literature", "historical", "tang_poetry"],
    "ar": ["quranic", "hadith", "muallaqat", "abbasid", "sufi_poetry", "proverb",
           "modern_media", "idiom", "folk_tale"],
    ...
    "ja": ["yojijukugo", "kanyoku", "kotowaza", "zen_koan", "classical_literature",
           "buddhist_text", "mythology", "historical", "modern_literature", "film_tv",
           "music", "idiom", "folk_tale", "aesthetic_concept"],
    "ko": ["sajaseong_eo", "pansori", "sijo", "korean_proverb", "classical_literature",
           ...
           "music", "folk_tale", "idiom", "visual_art"],
    "hi": ["doha_kabir", "doha_rahim", "ramcharitmanas", "bhagavad_gita", "mahabharata",
           ...
           "hindi_lokokti", "historical", "mythology", "classical_sanskrit",
           "hindu_philosophy", "visual_art", "idiom"],
