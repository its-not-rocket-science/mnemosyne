...
class TestCandidateExtraction:
    ...
    def test_each_candidate_is_vocabulary_or_nuance_type(self, plugin: ArabicPlugin) -> None:
...
class TestLessonData:
    ...
    def test_confidence_is_none_for_all_vocab_words(self, plugin: ArabicPlugin) -> None:
        # Honest: no frequency or morphological data → confidence unknown for vocabulary.
...
class TestEdgeCases:
    ...
    def test_all_returned_types_are_vocabulary_or_nuance(self, plugin: ArabicPlugin) -> None:
