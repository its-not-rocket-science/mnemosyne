...
class HebrewPlugin:
    ...
    def _extract_nuance(
        ...
        from backend.nuance.he import HebrewNuanceExtractor  # noqa: PLC0415

        nuance_candidates = HebrewNuanceExtractor().extract_nuance(
            sentence, [], candidates, self.language_code
        )
